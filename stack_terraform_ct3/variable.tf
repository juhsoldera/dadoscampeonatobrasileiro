...
# IAM USERS VARIABLES
# ------------------------
variable "attach_policy_arn_athena" {
  description = "Existing policy ARNs to attach to the IAM user"
  type        = string
  default     = "arn:aws:iam::aws:policy/AmazonAthenaFullAccess" #TODO - restringir se possível
}

variable "attach_policy_arn_s3" {
  description = "Existing policy ARNs to attach to the IAM user"
  type        = string
  default     = "arn:aws:iam::aws:policy/AmazonS3FullAccess" #TODO - restringir se possível
}
...
variable "private_subnet_ids" {
  ...
  EOD
  type        = list(string)
  default = ["subnet-00666616868faea55", "subnet-0c8221fb2f5606a9d"] #alterar aqui
}
...
variable "iam_role_name" {
  ...
  type        = string
  default     = "role-airflow-da-juliana"
}
...
variable "execution_role_arn" {
  ...
  EOD
  type        = string
  default     = "arn:aws:iam::103553036903:role/service-role/airflow-1-role" # alterar aqui
#   default     = null
}
#----------------------------------------------------------------
# MWAA S3 Bucket
...
variable "source_bucket_name" {
  ...
  EOD
  type        = string
  default     = "bucket-application-poc-juliana-4"
}
...
variable "source_bucket_arn" {
  ...
  type        = string
  default     = "arn:aws:s3:::bucket-application-poc-juliana-4"
}
...
variable "security_group_ids" {
  ...
  type        = list(string)
  default     = ["sg-0d6ee2bb250f00b28"] #alterar aqui
}
...
variable "vpc_id" {
  ...
  EOD
  type        = string
  default     = "vpc-0e9dc7df97516b345" # alterar aqui 
}
